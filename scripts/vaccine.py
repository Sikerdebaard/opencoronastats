...
df_vacc_model_data = df_nl['total_vaccinations_sans_boosters'].rename('total_vaccinations').dropna().to_frame()
...
df_vacc_model_data = df_vacc_model_data[df_vacc_model_data.index >= df_vacc_model_data[df_vacc_model_data['total_vaccinations'] == 0].index[-1]]
