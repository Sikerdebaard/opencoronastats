...
for page, data in pdata['pages'].items():
    ...
    for chart in data['charts']:
        ...
        dockercmd = f"docker run -it -w /usr/workspace -v {workdir.absolute()}:/usr/workspace joyzoursky/python-chromedriver:3.8-selenium bash -c \"pip install Pillow && python screencap.py '{chart_url}' {output}\""
        print(dockercmd)
